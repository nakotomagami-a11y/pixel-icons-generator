...
export type BladePommel =
  ...
  | "spike" | "faceted" | "flanged" | "crown" | "birdhead" | "crescent";
export type BladeModification =
  | "none" | "serrated" | "notched" | "fullered" | "riveted" | "wavy"
  | "fireTempered" | "runes" | "gems" | "etched";

export type AxeHead =
  | "fan" | "bearded" | "broad" | "double" | "crescent" | "halberd"
  | "warpick" | "hammer" | "greataxe" | "tomahawk";
export type AxeBack = "none" | "spike" | "pick" | "hammer" | "hook";
export type AxeButt = "none" | "ring" | "cap" | "spike";
export type AxeDecoration =
  | "none" | "gem" | "rivets" | "inlay" | "thongs"
  | "fuller" | "runes" | "notch" | "wrap" | "ferrule";

export type SpearHead =
  | "leaf" | "broadleaf" | "pike" | "winged" | "glaive"
...
export type ShieldShape =
  | "heater" | "kite" | "tower" | "round" | "crest" | "teardrop"
  | "lozenge" | "hexagon" | "scallop" | "oval";
export type ShieldBlazon =
  | "planked" | "marble" | "hammered" | "bone"
  | "scaled" | "leather" | "weave" | "verdigris" | "crystal"
  // Two-tone geometric patterns (pick two heraldic tinctures per seed).
