...
export const AXE_BUTT_OPTIONS = [
    { value: "none", label: "None" },
    { value: "ring", label: "End Ring" },
    { value: "cap", label: "Cap" },
    { value: "spike", label: "Spike" },
];
export const AXE_DECORATION_OPTIONS = [
    { value: "none", label: "None" },
    { value: "gem", label: "Gem" },
...
export const SPEAR_COLLAR_OPTIONS = [
    { value: "none", label: "None" },
...
export const SPEAR_BUTT_OPTIONS = [
    { value: "none", label: "None" },
    { value: "cap", label: "Cap" },
    { value: "spike", label: "Spike" },
...
export const SPEAR_DECORATION_OPTIONS = [
    { value: "none", label: "None" },
...
export const STAFF_BINDING_OPTIONS = [
    { value: "none", label: "None" },
...
export const STAFF_FOOT_OPTIONS = [
    { value: "none", label: "None" },
    { value: "ferrule", label: "Ferrule" },
    { value: "cap", label: "Cap" },
    { value: "spike", label: "Spike" },
...
export const SHIELD_RIM_OPTIONS = [
    { value: "none", label: "None" },
    { value: "metal", label: "Metal" },
